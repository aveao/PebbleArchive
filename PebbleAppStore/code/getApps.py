...
def loadAllPages(query):
	...
	currentPage = 1;
	data = '{"params":"query='+query+'&hitsPerPage=300&tagFilters=(watchapp%2Ccompanion-app)&page=0&analyticsTags=product-variant-time%2Cbasalt%2Cweb-desktop%2Cwatchapps%2Cappstore-search"}'
	...
	while currentPage < numberPages:
		data = '{"params":"query='+query+'&hitsPerPage=300&tagFilters=(watchapp%2Ccompanion-app)&page='+str(currentPage)+'&analyticsTags=product-variant-time%2Cbasalt%2Cweb-desktop%2Cwatchapps%2Cappstore-search"}'
